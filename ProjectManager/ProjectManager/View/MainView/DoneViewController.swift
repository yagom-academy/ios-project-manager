...
final class DoneViewController: UIViewController, UIGestureRecognizerDelegate, UIPopoverPresentationControllerDelegate {
    ...
    private let viewModel = DoneViewModel(databaseManager: LocalDatabaseManager.inMemory)
    ...
    private func presentModalEditView(indexPath: Int) {
        ...
        projectModificationController.title = ProjectStatus.done
    ...
    private func configurePopoverController(indexPath: Int, in cell: UITableViewCell) {
        ...
        controller.setTitle(firstButtonName: ProjectStatus.todo, secondButtonName: ProjectStatus.doing)
...
extension DoneViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        headerView.setupLabelText(section: ProjectStatus.done, number: viewModel.count)
