//
//  DoneProjectTableViewController.swift
//  ProjectManager
//
...
class DoneProjectTableViewController: UIViewController {
    ...
    func applySnapshot() {
        let projects = delegate?.readProject(of: .done)
...
extension DoneProjectTableViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        header.configureContent(status: String(describing: Status.done),
