...
struct ProjectListMockData {
  static let sample = [
    ...
    ProjectList(title: "라자냐 재료사러 가기", body: "프로젝트 회고를 작성하면 내가 이번 프로젝트에서 무엇을 놓쳤는지 명확히 알 수 있어요.", date: Date().advanced(by: -60*60*24), projectCategory: .todo),
    ...
    ProjectList(title: "빨래하기", body: "그만 쌓아두고...\n근데...\n여전히 하기 싫다", date: Date().advanced(by: -60*60*24), projectCategory: .todo),
    ...
    ProjectList(title: "오늘의 할일 찾기", body: "내가 가는 이길이 어디로 가는지 어디로 날 데려가는지 그 곳은 어딘지 알 수 없지만 알 수 없지만 알 수 없지만 오늘도 난 걸어가고 있네 사람들은 길이 다 정해져 있네", date: Date().advanced(by: -60*60*24), projectCategory: .done),
