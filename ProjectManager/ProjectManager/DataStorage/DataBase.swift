...
final class TempDataBase: DataBase {
    ...
    private func fetch() -> [Todo] {
            ...
            let tempTodoData = [
                Todo(status: Status(rawValue: tempTodoStatus!)!, title: tempTodoTitle!, description: tempTodoDescription!, date: Date()),
                Todo(status: Status(rawValue: tempDoneStatus!)!, title: tempDoneTitle!, description: tempDoneDescription!, date: Date()),
                Todo(status: Status(rawValue: tempDoingStatus!)!, title: tempDoingTitle!, description: tempDoingDescription!, date: Date())
            ]
